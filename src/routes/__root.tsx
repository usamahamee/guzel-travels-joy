...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Guzel Travels — Flights, Visas, Umrah & Car Rentals" },
      { property: "og:description", content: "Trusted travel partner in Lahore for flights, visas, Umrah and rentals." },
